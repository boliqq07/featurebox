...
from .angular_momentum import Wigner_D, factorial, deltacg, Wigner_D_wDerivative
...
class SO4_Bispectrum:
    ...
    def __init__(self, lmax=3, rcut=3, derivative=False, stress=False, normalize_U=False):
        # populate attributes
        self.lmax = lmax
        self.rcut = rcut
