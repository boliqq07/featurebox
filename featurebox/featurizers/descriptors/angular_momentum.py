    ...
    if ra <= epsilon:
        ...
        if (abs(twomp) > twol or abs(twom) > twol):
            ...
            if Prefactor == 0.0j:
                ...
                Sum = 1 / factorial(kmax) / factorial(l - m - kmax) / factorial(mp + m + kmax) / factorial(
                    l - mp - kmax)
        ...
        if (abs(twomp) > twol or abs(twom) > twol):
            ...
            if Prefactor == 0.0j:
                ...
                Sum = 1 / factorial(kmax) / factorial(l + mp - kmax) / factorial(l - m - kmax) / factorial(
                    -mp + m + kmax)
                for k in range(kmax - 1, kmin - 1, -1):
                    Sum *= x
        ...
        if (abs(twomp) > twol or abs(twom) > twol):
            ...
            if Prefactor == 0.0j:
                ...
                gradArr += D * ((mp + m) * gradRa / Ra + (l - mp) * gradRb / Rb + (l - m) * np.conj(gradRb / Rb)) + \
                           Prefactor * dSum * x * (
                                   gradRa / Ra - gradRb / Rb + np.conj(gradRa / Ra) - np.conj(gradRb / Rb))
                return D
        ...
        if (abs(twomp) > twol or abs(twom) > twol):
            ...
            if Prefactor == 0.0j:
                ...
                gradArr += D * ((l + mp) * gradRa / Ra + (m - mp) * gradRb / Rb + (l - m) * np.conj(gradRa / Ra)) + \
                           Prefactor * dSum * x * (
                                   gradRb / Rb - gradRa / Ra + np.conj(gradRb / Rb) - np.conj(gradRa / Ra))
                return D
